...
sltest.testmanager.exportResults(result,'C:\Matlab_Example\Test_Result\Results.mldatx'); 
resultObj = sltest.testmanager.importResults("C:\Matlab_Example\Test_Result\Results.mldatx"); 
sltest.testmanager.report(resultObj,...     
    'C:\Matlab_Example\Test_Result\Test_Report.pdf',... 	
